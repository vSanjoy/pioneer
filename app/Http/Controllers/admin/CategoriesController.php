...
class CategoriesController extends Controller
{
    ...
    public $pageRoute       = 'category';
    public $listUrl         = 'category.list';
    public $listRequestUrl  = 'category.ajax-list-request';
    public $addUrl          = 'category.add';
    public $editUrl         = 'category.edit';
    public $statusUrl       = 'category.change-status';
    ...
    */
    public function __construct($data = null) {
        ...
        $this->management   = trans('custom_admin.label_menu_category');
    ...
    */
    public function add(Request $request, $id = null) {
        $data = [
            'pageTitle'     => trans('custom_admin.label_add_category'),
            'panelTitle'    => trans('custom_admin.label_add_category'),
            'pageType'      => 'CREATEPAGE'
        ];
