                            ...
                            if ($user->type == 'SA' || $user->type == 'A') {
                                ...
                                if ($user->save()) {
                                    ...
                                    [
                                        ...
                                        $m->to($user->email, $user->full_name)->subject(trans('custom_admin.label_reset_password_link'));
                                    });
                ...
                if ($validator->fails()) {
                    ...
                    if ($token) {
                        ...
                        if ($details != null) {
                            ...
                            if ($details->save()) {
                                $this->generateToastMessage('success', trans('custom_admin.message_password_updated_success'), false);
