...
<body style="background:#efefef; margin:0; padding:0;">
  	<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, sans-serif; font-size:14px;">
    	<tbody>
      		...
      		<tr>
        		<td align="center" valign="middle" bgcolor="#000000" style="padding:20px; color:#ffffff; margin:0; border: 1px solid #0a0b0d; line-height: 22px;">&copy; {{ date('Y') }} <a href="{{ getBaseUrl() }}" style="color: #ffffff; text-decoration: none;">{!! $settingData['website_title'] !!}</a>, all rights reserved.</td>
      		</tr>
    	</tbody>
  	</table>
</body>
