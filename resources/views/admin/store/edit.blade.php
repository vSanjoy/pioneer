								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select name="sale_size_category" id="sale_size_category" class="form-control">
											<option value="">--Select--</option>
											<option value="S" @if ($details->sale_size_category == 'S')selected @endif>Small</option>
											<option value="M" @if ($details->sale_size_category == 'M')selected @endif>Medium</option>
											<option value="L" @if ($details->sale_size_category == 'L')selected @endif>Large</option>
										</select>
									</div>
								</div>
								<div class="col-md-6">
