			...
			<div class="card">
				<div class="card-body">
					...
					{{ Form::open([
						...
						'name'  => 'updateDistributionAreaForm',
						'id'    => 'updateDistributionAreaForm',
						'files' => true,
						'novalidate' => true ]) }}
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										{{ Form::text('definition', $details->definition, ['id' => 'definition','placeholder' => '','class' => 'form-control','required' => true]) }}
									</div>
								</div>
							</div>
						</div>
