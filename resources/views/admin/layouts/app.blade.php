...
<head>
    ...
    @if (strpos(Route::currentRouteName(), '.list') !== false || strpos(Route::currentRouteName(), '.details-list' ) !== false || strpos(Route::currentRouteName(), '.distribution-area-list' ) !== false || strpos(Route::currentRouteName(), '.distributor-list' ) !== false || strpos(Route::currentRouteName(), '.store-list' ) !== false || strpos(Route::currentRouteName(), '.beat-list' ) !== false || strpos(Route::currentRouteName(), '.season-list' ) !== false || strpos(Route::currentRouteName(), '.category-list' ) !== false || strpos(Route::currentRouteName(), '.product-list' ) !== false || strpos(Route::currentRouteName(), '.history' ) !== false || strpos(Route::currentRouteName(), '.report' ) !== false || strpos(Route::currentRouteName(), '.payment' ) !== false)
    <!-- DataTables -->
...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <!-- Page wrapper  -->
        <!-- ============================================================== -->
        <div class="page-wrapper" @if (\Auth::guard('admin')->user()->type == 'S') style="margin-left: 0;" @endif>
            <!-- ============================================================== -->
            ...
            @elseif (strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.distribution-area-list') == true || strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.beat-list') == true || strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.store-list') == true || strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.season-list') == true || strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.distributor-list') == true || strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.category-list') == true || strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.product-list') == true || strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.analysis') == true)
    ...
    @if (strpos(Route::currentRouteName(), '.list') !== false || strpos(Route::currentRouteName(), '.details-list') !== false || strpos(Route::currentRouteName(), '.distribution-area-list') !== false || strpos(Route::currentRouteName(), '.distributor-list') !== false || strpos(Route::currentRouteName(), '.store-list') !== false || strpos(Route::currentRouteName(), '.season-list') !== false || strpos(Route::currentRouteName(), '.beat-list') !== false || strpos(Route::currentRouteName(), '.category-list') !== false || strpos(Route::currentRouteName(), '.product-list') !== false || strpos(Route::currentRouteName(), '.history') !== false || strpos(Route::currentRouteName(), '.report') !== false || strpos(Route::currentRouteName(), '.payment' ) !== false)
    <!-- DataTables -->
