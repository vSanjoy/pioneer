...
<body>
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
        ...
        <div class="page-wrapper" @if (\Auth::guard('admin')->user()->type == 'S') style="margin-left: 0;" @endif>
            ...
            @elseif (strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.distribution-area-list') == true || strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.beat-list') == true || strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.store-list') == true || strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.season-list') == true || strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.category-list') == true || strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.product-list') == true || strpos(Route::currentRouteName(), 'singleStepSellerAnalyses.analysis') == true)
