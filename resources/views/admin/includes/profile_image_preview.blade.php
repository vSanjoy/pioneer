		...
		if (input.files[0].size > {{config('global.MAX_UPLOAD_IMAGE_SIZE')}}) {
			...
			if (extension == 'jpeg' || extension == 'jpg' || extension == 'gif' || extension == 'png' || extension == 'bmp') {
				...
				reader.onload = function (e) {
					...
					$('#'+imagePreviewId+'_preview').after('<div class="image-preview-holder" id="image_holder_'+imagePreviewId+'"><img src="'+e.target.result+'" class="image-preview-border" width="100" height=""/></div>');
				};
