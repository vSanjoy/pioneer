				...
				<div class="card-body">
					<h4 class="card-title">
						...
						<div class="float-right">
							<a class="btn btn-info waves-effect waves-light btn-rounded shadow-md pr-3 pl-3" href="{{ route($routePrefix.'.'.$addUrl, $areaAnalysisId) }}">
								<i class="fa fa-plus-circle" aria-hidden="true"></i> @lang('custom_admin.btn_add')
							</a>
						</div>
					</h4>	
					<h3>
